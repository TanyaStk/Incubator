package com.ddt.incubator.ui.fragments.habitlist.adapters
...
import com.ddt.incubator.ui.fragments.habitlist.HabitListDirections
    ...
    inner class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            itemView.cv_cardView.setOnClickListener {
                ...
                val action =
                    HabitListDirections.actionHabitListToMarkingHabit(habitsList[position])
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(
            LayoutInflater.from(parent.context).inflate(
                R.layout.recycler_habit_item, parent, false
            )
        )
    }
